...
// node_modules/react-toastify/dist/react-toastify.esm.mjs
var u = (t2) => typeof t2 == "number" && !isNaN(t2);
var d = (t2) => typeof t2 == "string";
  ...
  return function(e3) {
    ...
    return (0, import_react.useLayoutEffect)(() => {
      const t2 = f2.current, e4 = y2.split(" "), n2 = (o2) => {
        o2.target === f2.current && (t2.dispatchEvent(new Event("d")), t2.removeEventListener("animationend", n2), t2.removeEventListener("animationcancel", n2), T2.current === 0 && o2.type !== "animationcancel" && t2.classList.remove(...e4));
      };
...
function C(t2) {
  const [, o2] = (0, import_react.useReducer)((t3) => t3 + 1, 0), [l2, c] = (0, import_react.useState)([]), g2 = (0, import_react.useRef)(null), h2 = (0, import_react.useRef)(/* @__PURE__ */ new Map()).current, T2 = (t3) => l2.indexOf(t3) !== -1, C2 = (0, import_react.useRef)({ toastKey: 1, displayedToast: 0, count: 0, queue: [], props: t2, containerId: null, isToastActive: T2, getToast: (t3) => h2.get(t3) }).current;
  function I2(t3) {
  ...
  function b2(t3) {
    c((e2) => t3 == null ? [] : e2.filter((e3) => e3 !== t3));
  }
  function _2() {
  ...
  function L2(t3, n2) {
    ...
    if (!f(t3) || function(t4) {
      return !g2.current || C2.props.enableMultiContainer && t4.containerId !== C2.props.containerId || h2.has(t4.toastId) && t4.updateId == null;
    }(i2))
      return;
    const { toastId: l3, updateId: c2, data: T3 } = i2, { props: I3 } = C2, L3 = () => b2(l3), N2 = c2 == null;
    N2 && C2.count++;
    const M2 = { ...I3, style: I3.toastStyle, key: C2.toastKey++, ...i2, toastId: l3, updateId: c2, data: T3, closeToast: L3, isIn: false, className: m(i2.className || I3.toastClassName), bodyClassName: m(i2.bodyClassName || I3.bodyClassName), progressClassName: m(i2.progressClassName || I3.progressClassName), autoClose: !i2.isLoading && (R2 = i2.autoClose, w2 = I3.autoClose, R2 === false || u(R2) && R2 > 0 ? R2 : w2), deleteToast() {
      const t4 = y(h2.get(l3), "removed");
      h2.delete(l3), v.emit(4, t4);
      const e2 = C2.queue.length;
      if (C2.count = l3 == null ? C2.count - C2.displayedToast : C2.count - 1, C2.count < 0 && (C2.count = 0), e2 > 0) {
        const t5 = l3 == null ? C2.props.limit : 1;
        if (e2 === 1 || t5 === 1)
    ...
    M2.iconOut = function(t4) {
      ...
      return r4 === false || (p(r4) ? i3 = r4(l4) : (0, import_react.isValidElement)(r4) ? i3 = (0, import_react.cloneElement)(r4, l4) : d(r4) || u(r4) ? i3 = r4 : s3 ? i3 = E.spinner() : ((t5) => t5 in E)(o3) && (i3 = E[o3](l4))), i3;
    }(M2), p(i2.onOpen) && (M2.onOpen = i2.onOpen), p(i2.onClose) && (M2.onClose = i2.onClose), M2.closeButton = I3.closeButton, i2.closeButton === false || f(i2.closeButton) ? M2.closeButton = i2.closeButton : i2.closeButton === true && (M2.closeButton = !f(I3.closeButton) || I3.closeButton);
    let x2 = t3;
  ...
  function O2(t3, e2, n2) {
    ...
    h2.set(o3, s2), c((t4) => [...t4, o3].filter((t5) => t5 !== n2)), v.emit(4, y(s2, s2.props.updateId == null ? "added" : "updated"));
  }
...
function _(t2) {
  ...
  function v2(e2) {
    if (t2.draggable) {
      e2.nativeEvent.type === "touchstart" && e2.nativeEvent.preventDefault(), u2.didMove = false, document.addEventListener("mousemove", _2), document.addEventListener("mouseup", L2), document.addEventListener("touchmove", _2), document.addEventListener("touchend", L2);
      const n2 = c.current;
      u2.canCloseOnClick = true, u2.canDrag = true, u2.boundingRect = n2.getBoundingClientRect(), n2.style.transition = "", u2.x = I(e2.nativeEvent), u2.y = b(e2.nativeEvent), t2.draggableDirection === "x" ? (u2.start = u2.x, u2.removalDistance = n2.offsetWidth * (t2.draggablePercent / 100)) : (u2.start = u2.y, u2.removalDistance = n2.offsetHeight * (t2.draggablePercent === 80 ? 1.5 * t2.draggablePercent : t2.draggablePercent / 100));
    }
  }
  function T2(e2) {
    if (u2.boundingRect) {
      const { top: n2, bottom: o3, left: s2, right: a3 } = u2.boundingRect;
      e2.nativeEvent.type !== "touchend" && t2.pauseOnHover && u2.x >= s2 && u2.x <= a3 && u2.y >= n2 && u2.y <= o3 ? C2() : E2();
    }
  }
  function E2() {
    a2(true);
  ...
  function _2(e2) {
    const n2 = c.current;
    u2.canDrag && n2 && (u2.didMove = true, o2 && C2(), u2.x = I(e2), u2.y = b(e2), u2.delta = t2.draggableDirection === "x" ? u2.x - u2.start : u2.y - u2.start, u2.start !== u2.x && (u2.canCloseOnClick = false), n2.style.transform = `translate${t2.draggableDirection}(${u2.delta}px)`, n2.style.opacity = "" + (1 - Math.abs(u2.delta / u2.removalDistance)));
  }
  function L2() {
...
function O(e2) {
  ...
  const h2 = r3 || u2 && d2 === 0, y2 = { ...l2, animationDuration: `${n2}ms`, animationPlayState: o2 ? "running" : "paused", opacity: h2 ? 0 : 1 };
...
Q.loading = (t2, e2) => H(t2, S("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...e2 })), Q.promise = function(t2, e2, n2) {
  ...
  B.size > 0 ? v.emit(1, t2) : D = D.filter((e2) => t2 != null && e2.options.toastId !== t2);
}, Q.clearWaitingQueue = function(t2) {
  return t2 === void 0 && (t2 = {}), v.emit(5, t2);
}, Q.isActive = (t2) => {
  let e2 = false;
  return B.forEach((n2) => {
  ...
  B.delete(t2.containerId || t2), B.size === 0 && v.off(0).off(1).off(5);
});
export {
  R as Bounce,
  $ as Flip,
